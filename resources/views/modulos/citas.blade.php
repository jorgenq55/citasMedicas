        ...
        <div class="modal-content" >
            <form method="post" >
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">Pedir Citas</button>
        ...
        <div class="modal-content" >
            <form method="post" action="{{ url('borrar-cita')}}">
                ...
                <div class="modal-body">
                 ...
                 <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">Cancelar Citas</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                </div>    
            </form>
        </div>
            ...
            <form method="post">
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control input-lg" id="FyHinicioP" readonly="FyHinicioP" readonly>
                            <input type="hidden" class="form-control input-lg" id="FyHfinalP" readonly="FyHfinalP" readonly>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary" type="submit">Pedir Citas</button>
