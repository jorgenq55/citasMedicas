                    ...
                    <div class="box-body">
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @error('password')
                                <div class="alert alert-danger">La contraseña es muy corta o muy larga</div>
                            @enderror
                        </div> 
                    </div>
                </div>
                    ...
                    <div class="box-body">
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control input-lg" name="password"  value="{{ $secretaria->password}}">
